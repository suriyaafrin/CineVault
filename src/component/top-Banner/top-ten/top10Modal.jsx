          ...
          <div className="flex gap-0 rounded-xl overflow-hidden border border-gray-100  bg-gray-50  mb-4">
            ...
            <div className="p-3.5 flex flex-col justify-between min-w-0">
              <div>
                <div className="flex items-baseline gap-2 mb-1.5">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-1 flex-wrap mt-0.5">
                      <span className="text-[11px] text-gray-500">{featured.year}</span>
                      <span className="text-gray-300 dark:text-zinc-600">·</span>
                      <span className="text-[11px] text-gray-500">{featured.duration}</span>
                      <span className="bg-yellow-100 text-yellow-700 text-[10px] px-1.5 py-0.5 rounded font-medium">{featured.genre}</span>
                    </div>
                  </div>
                </div>
                ...
                <p className="text-[12px] text-gray-500 dark:text-gray-400 leading-relaxed line-clamp-2">{featured.description}</p>
              </div>
              <div className="flex gap-2 mt-3">
                <button className="flex items-center gap-1.5 bg-[#C8102E] text-white text-[12px] font-medium px-3.5 py-1.5 rounded-full hover:opacity-90 transition-opacity">
                ...
                >
                  ...
                  <div className="flex items-stretch">
                    ...
                    <div className="px-2.5 py-2 flex flex-col justify-center min-w-0">
                      ...
                      <p className="text-[11px] text-gray-400 truncate">{movie.year} · {movie.genre}</p>
                  ...
                  <div className="flex gap-1.5 px-2.5 pb-2.5 pt-1.5 border-t border-gray-100 dark:border-zinc-700">
                    <button className="flex-1 flex items-center justify-center gap-1 bg-[#C8102E] text-white text-[11px] font-medium py-1.5 rounded-full hover:opacity-90 transition-opacity">
