...
export const useWatchStore = create((set) => ({
  items: [
    ...
    },
    {
      ...
      thumbnail: "https://images.unsplash.com/photo-1604975999044-188783d54fb3?w=400&q=80",
      progress: 33,
    ...
    },
    {
      ...
      thumbnail: "https://images.unsplash.com/photo-1598899134739-24c46f58b8c0?w=400&q=80",
      progress: 75,
